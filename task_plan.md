...
- [x] **Phase 7: Advanced Vault Workflows**
    - [x] `/inbox` - Process max 5 items from Check Later.
    - [x] `/quiz` - Spaced repetition and active recall.
    - [x] `/kindle` - Kindle raw highlights sync and synthesis architecture.
    - [x] Setup KUAL Extension on Kindle device to trigger sync script.
